...
const data = {
    ...
    "index_14":{
        ...
        "test":[
            ...
            {"definitions": [
                "Годные",
                "<p class='popup_zoom_plc zoom_paragraph'>Годная только при сопряжении с новыми или отремонтированными до номинальных размеров деталями</p>",
                "Подлежащие ремонту на данном предприятии",
                "<p class='popup_zoom_plc zoom_paragraph'>Подлежащие ремонту на специализированных предприятиях</p>",
    ...
    "index_15":{
        ...
        "test": [{
            ...
            "columns": ['Возможная причина', 'Способ устранения', 'Не верные варианты']
        }],
    },
    "index_16":{
        "subtitle": "Результаты",
